...
let officialData = [
    ...
    {date: new Date("2020-02-10"), official:43143},
...
function simulate() { 
    ...
    if(span) span.innerHTML = round(err);
	  lineChart(res, true, baseOptions.tick, 1200, 700, baseOptions);
}
...
/* 	function arrSum(arr) {
  ...
  return copy
	...
	function modelForNextDay(model, day, infectPerDay, becomeSpreader, daysAsSpreader, lockdown, spreadReduction) {
	  ...
	  return { newModel: [Math.min(MAX_NEW_INFECTION,newInfections), ...forwardOneDay], actualPerDay: perDay};
	}
...
function dateFormatter(time) {
  ...
  function setOptionValues() {
	 ...
	 function getInterfaceInfo() {
      ...
      {name: "initial",        val: 60, min: 1, max:600, title: "Initially infected", step: 0.1,
      ...
      {name: "daysOfSimulation", val: 190,    min: 15,     max: 300,  step: 10, title: "Simul. Len", 
